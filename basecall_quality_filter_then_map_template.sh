...
samtools view -@ 10 -bh - | \
samtools sort -@ 10 > ${BASE_DIR}/MAPPED_BAM_BQ_FILTERED/${SAMPLE_ID}.sorted_minimap2_bq10_filtered.bam

# make output mapped BAM index
samtools index ${BASE_DIR}/MAPPED_BAM_BQ_FILTERED/${SAMPLE_ID}.sorted_minimap2_bq10_filtered.bam
